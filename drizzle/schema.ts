import { pgTable, uuid, text, timestamp, unique, numeric, integer, boolean, foreignKey, real, jsonb, uniqueIndex, pgEnum } from "drizzle-orm/pg-core"
...
export const productVariants = pgTable("product_variants", {
	...
	foreignKey({
			...
			name: "product_variants_size_id_sizes_id_fk"
		}).onDelete("restrict"),
